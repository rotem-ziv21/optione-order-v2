-- עדכון הטריגר כדי לחפש לקוח לפי customer_id במקום id
...
BEGIN
  ...
  IF (NEW.status = 'completed') THEN
    ...
    LOOP
      ...
      -- שליפת פרטי הלקוח - חיפוש לפי customer_id במקום id
      BEGIN
...
-- לוג שהטריגר עודכן בהצלחה
INSERT INTO debug_logs (message) VALUES ('Webhook trigger updated to search by customer_id');
