-- פתרון ספציפי לשליחת אימייל של לקוח ב-webhook

-- הוספת רשומת בדיקה לטבלת הלוגים
INSERT INTO debug_logs (message) VALUES ('Starting email webhook solution setup');
...
BEGIN
  ...
  LOOP
    INSERT INTO debug_logs (message) VALUES ('Potential email column found: ' || column_name);
  END LOOP;
END $$;
...
INSERT INTO debug_logs (message) VALUES ('Email webhook solution created successfully');
